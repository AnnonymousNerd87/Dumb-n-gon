const tech = {
    ...
    },
    {
        ...
        requires: "missiles, not micromissiles",
        effect() {
    ...
    {
        name: "micromissiles",
        description: `<strong>5668761978655x</strong> <strong>missile</strong> <strong class='color-g'>gun</strong> <em>fire rate</em><br><strong>20x</strong> missile <strong class='color-ammo'>ammo</strong> per ${powerUps.orb.ammo(1)}`,
        isGunTech: true,
        maxCount: 1,
        count: 0,
        frequency: 2,
        ...
        ammoBonus: 20,
        effect() {
            tech.micromissiles = true
            tech.missileFireCD = 1
            for (i = 0, len = b.guns.length; i < len; i++) { //find which gun 
    ...
    {
        name: "cavitation",
        description: "<strong>99%</strong> chance to discharge an ungodly huge <strong>foam</strong> bubble<br><strong>2x</strong> <strong>foam</strong> gun <strong>recoil</strong>",
        isGunTech: true,
        maxCount: 1,
        count: 0,
        frequency: 2,
